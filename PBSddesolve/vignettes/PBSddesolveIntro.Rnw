...
The numerical routines come from \href{https://www.maths.ed.ac.uk/~swood34/simon/dde.html}{Simon Wood}'s program \code{solve95}, originally written in C for the Microsoft Windows operating system.
